...
X_train = scaling.transform(X_train)
X_validation = scaling.transform(X_validation)
# pickle.dump(scaling, open("splitted_text/scaler.pkl", "wb"))
...
# pickle.dump(light, open("splitted_text/lightgbm.pkl", "wb"))
...
# pickle.dump(lsvc, open("splitted_text/linearsvc.pkl", "wb"))
...
# pickle.dump(rforrest, open("splitted_text/rforest.pkl", "wb"))
...
# knn.fit(X_train, Y_train)
# pickle.dump(knn, open("splitted_text/knn.pkl", "wb"))
# predictions = knn.predict(X_validation)
# print(accuracy_score(Y_validation, predictions))
# print(confusion_matrix(Y_validation, predictions))
# print(classification_report(Y_validation, predictions))
